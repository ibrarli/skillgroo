...
export default function AuthModal() {
  ...
  return (
    <>
      {/* Trigger Button - Ensure it matches your UserProfile style */}
      <button
        onClick={() => {
          setOpen(true);
          setIsLogin(true);
      ...
      >
        ...
        <LogIn
          size={15}
          strokeWidth={2.5}
          className="text-neutral-400 dark:text-neutral-500 group-hover:text-white dark:group-hover:text-black group-hover:translate-x-0.5 transition-all"
        />
      </button>
          ...
          <div className="bg-neutral-950 border border-white/10 rounded-[2.5rem] w-full max-w-4xl overflow-hidden flex flex-col md:flex-row shadow-2xl animate-in zoom-in duration-300">
            ...
            <div className="flex-1 p-8 md:p-12 relative flex flex-col justify-center">
              ...
              <form onSubmit={handleAuth} className="space-y-4">
                ...
                {error && (
                  <p className="text-red-500 text-[10px] font-black uppercase tracking-widest bg-red-500/10 p-3 rounded-xl">
                    {error}
                  </p>
                )}
