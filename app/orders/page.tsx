      ...
      <div>
        ...
        <main className="flex-1 ml-24 p-8 pt-24">
          <div className="max-w-6xl mx-auto space-y-12 pb-20">
            ...
            {/* BUYING SECTION (Customer View) */}
            <section className="space-y-6">
              <div className="flex items-center gap-3 border-b dark:border-neutral-800 pb-4">
                <div className="p-2.5 bg-neutral-100 dark:bg-neutral-900 text-neutral-500 rounded-xl">
                  <ShoppingBag size={22} />
                </div>
                <h2 className="text-xl font-black dark:text-white">Purchased Services</h2>
              </div>
              ...
              {customerOrders.length > 0 ? (
                ...
                <div className="py-12 flex flex-col items-center justify-center bg-white dark:bg-neutral-900/50 border border-dashed border-neutral-200 dark:border-neutral-800 rounded-[3rem] text-center">
                  ...
                  <p className="text-neutral-400 font-bold uppercase text-xs tracking-widest">No purchases yet</p>
                </div>
              )}
            </section>
